        ...
        <div className="bg-maybe-dark-background w-full h-screen">
            <div className="mx-4 text-left text-white bg-maybe-dark-background pt-20 transform pb-36 policy-text">
                ...
                <h2 className="font-light text-lg pt-10 md:w-full mb-12 pb-38">
                    ...
                    What User Data We Collect <br/><br/>
                    ...
                    • To customize our website according to your online behavior and personal preferences.<br/><br/>
                    ...
                    Planner X will not lease, sell or distribute your personal information to any third parties, unless we
