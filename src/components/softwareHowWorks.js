        ...
        <div>
            <div className=" bg-maybe-dark-background w-full h-screen pt-10 lg:pt-0 pb-20">
                ...
                <div  id="tips-about-page" className="mb-10 p-0 flex flex-col-reverse w-full lg:flex-row-reverse md:p-16 md:mb-18 ">
                    ...
                    <h2 className="text-transparent bg-clip-text bg-gradient-to-br from-purple-text to-orange-text text-4xl sm:text-4xl md:text-6xl lg:text-5xl 2xl:text-8xl font-semibold text-dark-text py-0">
