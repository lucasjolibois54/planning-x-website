  ...
  return (
    ...
    <div className="w-full h-screen flex justify-center items-center">
        ...
        <h1 className="text-transparent bg-clip-text bg-gradient-to-br from-purple-text to-orange-text text-4xl md:text-7xl text-center font-semibold ">Your digital <br/> daily reminder</h1>
            <h2 className="font-light text-lg mt-10 md:ml-20 md:w-96 md:mr-20 sm:pr-0 mb-12">Planner X is a revolutionary, free to use highly innovative software solution helping your work team traking their tasks and roles! Using our system, you'll be able to distribute work tasks/ assignments to your team through the app. The members of your team will later on be able to mark the task when it's done. It's simple, and it is free! What's not to like?</h2>
            <div>
