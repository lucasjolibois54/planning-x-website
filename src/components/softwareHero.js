            ...
            <div className="mx-4 text-center text-white mt--1/3  md:left-1/2 right-1/2">
                ...
                <div>
                    ...
                    <div className="md:w-2/6">
                            <h2 className="font-light text-lg mt-4 text-center sm:pr-0 mb-7">Our software easen your workflow and makes it easier for you to work and keeping track of the work being done through out the day art the office. Additionally it’ll also give your a clear strucutre of the tasks to be done as well as an overview.</h2>
