  ...
  return (
    ...
    <div className="w-full h-screen flex justify-center items-center">
        ...
        <h1 className="text-transparent bg-clip-text bg-gradient-to-br from-purple-text to-orange-text text-7xl text-center font-semibold ">Your digital <br/> daily reminder</h1>
            <h2 className="font-light text-lg mt-10 ml-96 w-96 mr-96 mb-12">Covid -19 is a world known virus that has affected millions of people. Wearing a mask has been our number one solution to stay safe and protect others. Why not invest in a high quality mask with focus in breathability, safety & design?</h2>
            <div>
