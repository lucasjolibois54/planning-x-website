            ...
            <div className=" bg-maybe-dark-background w-full h-screen pt-10 lg:pt-0 pb-10">
                ...
                <div id="" className="mb-28 p-0 flex flex-col-reverse w-full lg:flex-row-reverse md:p-16 md:mb-18 ">
                    <div className="w-full lg:w-9/12 lg:text-left">
                        <img  data-aos="fade-up" src={DownloadSteps} className="pt-6 lg:pr-20" alt="The Team" />
                    </div>
                    <div className="md:mr-7 flex text-center flex-col w-full px-3 justify-center lg:w-5/10 lg:text-left xl:pl-10">

                        <h2  data-aos="fade-up" className="lg:text-right  md:mr-7 px-2 text-transparent bg-clip-text bg-gradient-to-br from-purple-text to-orange-text text-5xl sm:text-5xl md:text-6xl lg:text-7xl 2xl:text-7xl font-semibold text-dark-text py-0">
                        How to download
                        </h2>
                        <p   data-aos="fade-up"className="text-xl font-light text-light-background px-2 text-dark-text py-5 md:mr-7 xl:pl-0  lg:text-right">
