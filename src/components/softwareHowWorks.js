        ...
        <div>
            <div className=" bg-maybe-dark-background w-full h-screen pt-10 lg:pt-0 pb-20">
                ...
                <div  id="tips-about-page" className="mb-10 p-0 flex flex-col-reverse w-full lg:flex-row-reverse md:p-16 md:mb-18 ">
                    ...
                    <h2 data-aos="fade-up" className="text-transparent bg-clip-text bg-gradient-to-br from-purple-text to-orange-text text-4xl sm:text-4xl md:text-6xl lg:text-5xl 2xl:text-8xl font-semibold text-dark-text py-0">
                    A bit about how<br /> it works
                        ...
                        <div className="text-lg text-light-background px-5 text-dark-text py-5 md:px-24 lg:px-0 xl:pl-0 xl:pr-20">
                            <ul>
                                <li data-aos="fade-up" className="list-disc"><p className="font-light text-left">The application is a SPA SaaS web application and it easen your workflow with your team. Through the app you can distribute tasks while also adding a timeframe & more.</p></li><br/>
                                <li data-aos="fade-up" className="list-disc"><p className="font-light text-left">Through Planner X, your coworkers will be able to mark their tasks as done when they have finished it, which will give you a clear overview of what has been done throughout the day.</p></li>
                            </ul>
                        </div>
