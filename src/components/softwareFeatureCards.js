...
function MyApp() {
    ...
    return (
        ...
        <div className=" bg-maybe-dark-background flex flex-col ">
          <div className="relative m-3 flex flex-wrap mx-auto ">
        
            <div className="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
              <div className="overflow-x-hidden rounded-2xl relative">
                <img className="h-40 rounded-2xl w-full object-cover" src="https://avatars.githubusercontent.com/u/74597842?v=4"/>
