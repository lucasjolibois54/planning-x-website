                            ...
                            <div className="sm:flex">
                                <div className="sm:flex-1">
                                    ...
                                    <div>
                                        ...
                                        <a className="cursor-pointer text-gray-footer py-1 block hover:underline"  onClick={() => { navigate("/aboutUs") }}>Top of about page</a>
                                    </div>
                                </div>
                                <div className="sm:flex-1 mt-4 sm:mt-0">
                                    ...
                                    <div>
                                        ...
                                        <a className="cursor-pointer text-gray-footer py-1 block hover:underline"  onClick={() => { navigate("/software") }}>Top of Software page</a>
                                    </div>
                                </div>
                            </div>
                        </div>
